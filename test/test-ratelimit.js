...
describe('Rate limit', function() {
  ...
  it('bad input', function() {
    ...
    }, /Invalid MYCORS_RATELIMIT\. Regex at index 0 must start and end with a slash \("\/"\)\./);

    assert.throws(function() {
      createRateLimitChecker('0 1 a /');
    }, /Invalid MYCORS_RATELIMIT\. Regex at index 1 must start and end with a slash \("\/"\)\./);
